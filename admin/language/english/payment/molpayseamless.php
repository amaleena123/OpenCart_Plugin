...
// Heading
$_['heading_title']      = 'MOLPay Seamless Payment Gateway';

// Text 
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified MOLPay Malaysia Online Payment Gateway account details!';
$_['text_molpayseamless']   = '<a onclick="window.open(\'http://www.molpay.com/\');" style="text-decoration:none;"><img src="http://www.molpay.com/molpay_checkout.gif" alt="MOLPay Online Payment Gateway" title="MOLPay Malaysia Online Payment Gateway" style="border: 0px solid #EEEEEE;" height=63 width=198/></a>';
...
$_['entry_set_timer']      = 'Set Timer:';
$_['entry_channel']         = 'Payment Channels:';
